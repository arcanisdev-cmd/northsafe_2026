  ...
  return (
    <div>
      <div className="max-w-[1532px] mx-auto">
        ...
        <div
          style={{ backgroundColor: "#D4D3FF" }}
          className="px-5 py-6 sm:px-8 sm:py-8 md:px-12 lg:px-[108px] lg:py-8"
        >
          <h1
            className="font-inter font-bold text-xl sm:text-2xl text-center"
            style={{ color: "#0D0B61" }}
          >
            Report a Hazard
          </h1>
          ...
          >
            ...
            <div className="w-full max-w-[404px]">
              ...
              <button
                ...
                className="w-full rounded-[10px] text-white font-inter font-bold text-sm mt-6 lg:mt-10 transition-opacity disabled:opacity-40 disabled:cursor-not-allowed"
                style={{
                  height: "44px",
