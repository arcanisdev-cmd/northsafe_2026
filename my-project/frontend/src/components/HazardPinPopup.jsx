...
const ALERT_DOT_BY_LEVEL = alertLevelOptions.reduce(
  (acc, opt) => {
...
function HazardPinPopup({ report }) {
  return (
    <div className="font-sans w-[240px] sm:w-[260px] max-w-[calc(100vw-60px)]">
      <div className="flex items-center justify-between mb-2">
        ...
        <span
          ...
          style={{
            backgroundColor:
              ALERT_DOT_BY_LEVEL[report.alertLevel],
          }}
        />
      </div>
      ...
      <p className="text-[11px] text-gray-500 mb-1 break-words">
        {report.address}
      </p>
